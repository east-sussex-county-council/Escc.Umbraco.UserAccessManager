...
robocopy $sourceFolder "$destinationFolder/$projectName" /MIR /IF *.gif *.png *.eot *.svg *.ttf *.woff *.cshtml *.asax *.aspx *.dll *.less *.txt *.ps1 *.js *.map *.css csc.* csi.* /XD aspnet_client obj Properties App_Start
